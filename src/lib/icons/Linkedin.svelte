<script>
	let { size = '24', color = 'currentColor', ariaLabel = 'Linkedin Icon', ...rest } = $props();
</script>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width={size} height={size} fill={color} aria-label={ariaLabel} {...rest}
