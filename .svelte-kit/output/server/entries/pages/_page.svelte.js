...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<!----></div> <a class="text-lg xl:text-xl font-bold rounded-full bg-dark dark:bg-light hover:opacity-80 px-[1em] py-[0.5em] text-light dark:text-dark" href="https://www.threads.net/intent/follow?username=nwtseira" target="_blank">Follow</a></div></div> <div class="px-5 text-xl text-center md:text-left md:text-2xl lg:text-2xl xl:text-2xl md:px-0"><p>Hello 👋, <br>I'm Digital Marketer &amp; Power Mac User.</p> <p class="mt-[1em]"><a href="https://" class="underline">Join my email list</a> for product updates and free stuff I make for other solo builders.</p></div> <div class="flex items-center justify-center gap-10 py-6 mt-auto lg:py-0 md:justify-start"><a class="p-2 -m-2 opacity-100 hover:opacity-60" href="https://www.threads.net/intent/follow?username=nwtseira" target="_blank">`;
  ...
  $$payload.out += `<!----></a></div></div> <div class="col-span-12 p-6 -mt-6 lg:col-span-6 xl:col-span-7 md:p-12 lg:p-16 xl:p-20 2xl:p-24 lg:pl-0 xl:pl-0 2xl:pl-0 md:-mt-12 lg:mt-0"><div class="flex flex-col gap-6 text-base md:text-xl md:gap-6 lg:gap-7 xl:gap-8"><a class="rounded-[20px] md:rounded-[25px] p-5 md:p-6 bg-dark/5 hover:bg-dark/10 dark:bg-light/5 dark:hover:bg-light/10 flex items-center gap-[1.5em]" href="https://youtu.be/CYWoB5FUsps" target="_blank"><div class="w-[80px] md:w-[90px] md:h-[90px] md:rounded-[18px] h-[80px] rounded-[15px] shrink-0 flex items-center justify-center bg-light dark:bg-dark">`;
  Xyoutube($$payload);
